...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="fixed right-5 bottom-5 z-[35] inline-flex items-center gap-2 rounded-full bg-[var(--whatsapp)] px-4 py-3 text-white shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-transform duration-200 hover:scale-105 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--brand-accent-1)] animate-[fab-enter_420ms_cubic-bezier(0.22,1,0.36,1)] md:right-7 md:bottom-7"
    >
